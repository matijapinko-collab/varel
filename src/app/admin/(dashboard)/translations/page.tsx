...
export default async function AdminTranslationsPage() {
  ...
  collect("tool", tools as never, "/admin/tools");
  collect("article", articles as never, "/admin/guides");
  collect("editorial", editorials as never, "/admin/editorial");
  collect("news", news as never, "/admin/news");
  collect("comparison", comparisons as never, "/admin/comparisons");
  collect("prompt", prompts as never, "/admin/prompts");
  collect("deal", deals as never, "/admin/deals");
