...
export default async function AdminDashboard() {
  ...
  const stats = [
    ...
    { label: "Published tools", value: publishedTools, href: "/admin/tools" },
    { label: "Draft tools", value: draftTools, href: "/admin/tools" },
    { label: "Published articles", value: publishedArticles, href: "/admin/guides" },
    { label: "Draft articles", value: draftArticles, href: "/admin/guides" },
  ];
